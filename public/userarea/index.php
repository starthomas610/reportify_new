                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="card card-body">
                                        <a href="importify.php"><div class="alert alert-warning alert-dismissible fade show px-4 mb-0 text-center" role="alert">
                                                                    <i class="mdi mdi-database-import d-block display-4 mt-2 mb-3 text-warning"></i>
                                                                    <h5 class="text-primary"><?php echo $products; ?></h5>
                                                                    <p class="text-primary"><?php echo $productsdet; ?></p>
                                ...
                                <div class="col-lg-3">
                                    <div class="card card-body">
                                        <a href="importify.php"><div class="alert alert-primary alert-dismissible fade show px-4 mb-0 text-center" role="alert">
                                                                    <i class="mdi mdi-file-document-box d-block display-4 mt-2 mb-3 text-primary"></i>
                                                                    <h5 class="text-primary"><?php echo $reports; ?></h5>
                                                                    <p class="text-primary"><?php echo $reportsdet; ?></p>
                                ...
                                <div class="col-lg-3">
                                    <div class="card card-body">
                                        <a href="importify.php"><div class="alert alert-info alert-dismissible fade show px-4 mb-0 text-center" role="alert">
                                                                    <i class="mdi mdi-signal d-block display-4 mt-2 mb-3 text-info"></i>
                                                                    <h5 class="text-primary"><?php echo $statkpi; ?></h5>
                                                                    <p class="text-primary"><?php echo $statkpidet; ?></p>
                                ...
                                <div class="col-lg-3">
                                    <div class="card card-body">
                                        <a href="importify.php"><div class="alert alert-success alert-dismissible fade show px-4 mb-0 text-center" role="alert">
                                                                    <i class="mdi mdi-database-import d-block display-4 mt-2 mb-3 text-success"></i>
                                                                    <h5 class="text-primary"><?php echo $importify; ?></h5>
                                                                    <p class="text-primary"><?php echo $importifydet; ?></p>
